...
public class PrioritizedHandlerTest {
    ...
    /**
     * Запрос к отсортированному списку
     * GET: /prioritized
     */
    @Test
    void testGetPrioritized() throws IOException, InterruptedException {
        System.out.println("Запрос к отсортированному списку GET: /prioritized");
        ...
        assertEquals(2, historyList.size(), "В истории должно быть 3 просмотра");
    }
